...
/// <para>
/// Unlike window-based strategies, the token bucket allows short bursts while still
/// enforcing a sustained average rate. The refill rate is derived from
/// <see cref="ClientRateLimit.Window"/> (refill interval) and
/// <see cref="ClientRateLimit.TokensPerRefill"/> (tokens added per interval).
/// </para>
/// </summary>
public class TokenBucketStrategy : IRateLimitStrategy
{
    ...
    public TokenBucketStrategy(IRateLimitStateDatabase stateStore)
    {
