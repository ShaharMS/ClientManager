...
/// </summary>
public class AccessDeniedException : HttpProblemException
{
    public string ClientId { get; }
    public string ServiceId { get; }

    public AccessDeniedException(string clientId, string serviceId)
        : base(StatusCodes.Status403Forbidden, "Forbidden", $"Client '{clientId}' does not have access to service '{serviceId}'")
    {
        ClientId = clientId;
        ServiceId = serviceId;
    }
