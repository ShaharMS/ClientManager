...
3. **~30s dashboard cards stuck** — API overview + Redis; use the Redis tuning checklist and API logs (`counter_get_by_prefix`, `RequestTrackingMiddleware` slow requests).
