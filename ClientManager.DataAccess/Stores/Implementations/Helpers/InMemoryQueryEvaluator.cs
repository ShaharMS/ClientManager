...
/// Used as the fallback engine for stores that don't support native query translation
/// (e.g. <c>JsonFileDocumentStore</c>) and as a safety net for any store.
/// </summary>
public static class InMemoryQueryEvaluator
{
    ...
    ///
    /// <para>
    /// This is the universal fallback used by every <see cref="IDocumentStore"/> that does
